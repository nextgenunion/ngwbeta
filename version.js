...
// ships changed files. Everything else (the on-screen "Beta v2.0.7" label,
// the service worker's cache-busting tag) is derived from this one value,
// so there is no second or third place that can drift out of sync with it.
//
// Loaded two ways:
...
var SONGBOOK_VERSION_NUMBER = '2.0.16';
...
// On-screen label, e.g. "Beta v2.0.7". Shown via versionSub(v) in every
// lang/*.js file on the About/Settings page.
var SONGBOOK_APP_VERSION = 'Beta v' + SONGBOOK_VERSION_NUMBER;
