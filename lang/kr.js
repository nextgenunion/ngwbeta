...
window.SONGBOOK_LANG.kr = {
  ...
  lyricsWeightTitle: "가사 스타일",
  lyricsWeightSub: "가사 텍스트의 글자 굵기",
  lyricsWeightNormal: "보통",
  lyricsWeightSemibold: "세미볼드",
  lyricsWeightBold: "굵게",
  lyricsSpacingTitle: "줄 간격",
  lyricsSpacingSub: "가사 줄 사이의 세로 간격",
  ...
  reloadSub: "모든 곡을 다시 다운로드하거나 앱을 완전히 다시 불러옵니다.",
  reloadBtn: "새로고침",
  ...
  // ---- 내 곡 + 곡 편집기 (v3) ----
  userSongsTitle: "내 곡",
  userSongsEmptyState: "아직 내가 만든 곡이 없어요. +를 눌러 첫 곡을 써보세요.",
  newSongTitle: "새 곡",
  editSongTitle: "곡 수정",
  editorTitleLabel: "제목",
  editorArtistLabel: "아티스트 / 밴드",
  editorKeyLabel: "조",
  editorKeyPlaceholder: "예: G, Am",
  editorAudioLabel: "오디오 링크 (선택)",
  editorAudioPlaceholder: "https://…",
  editorLyricsLabel: "가사 및 코드",
  editorLyricsHint: "코드가 놓이는 음절 바로 앞에 대괄호로 적어주세요. 예: [Am]오 거룩하신 [G]놀라운 하나님. 절/후렴 사이에는 빈 줄을 남겨주세요.",
  editorPreviewLabel: "미리보기",
  editorPreviewEmpty: "위에 가사를 입력하면 여기에 표시됩니다.",
  deleteSongBtn: "곡 삭제",
  deleteSongTitle: "곡 삭제",
  deleteSongConfirm: (title) => `"${title}" 곡을 삭제할까요? 이 작업은 되돌릴 수 없습니다.`,
  toastSongTitleRequired: "저장하기 전에 곡 제목을 입력해 주세요",
  toastSongCreated: "곡이 생성되었습니다",
  toastSongUpdated: "곡이 수정되었습니다",
  toastSongDeleted: "곡이 삭제되었습니다",
  toastSongSaveFailed: "저장하지 못했습니다 — 다시 시도해 주세요",
  ...
  playlistsBackupSub: "재생목록을 파일로 복사하여 다른 사람과 공유하세요.",
  exportBtn: "내보내기",
  importBtn: "가져오기",
  ...
  devSabbathSub: "요일과 상관없이 행복한 안식일 인사를 전하는 예수님 마스코트를 항상 표시합니다.",
  devChristmasTitle: "크리스마스 눈 강제 활성화",
  devChristmasSub: "요일이나 월과 상관없이 크리스마스 눈 모드를 항상 표시합니다.",
